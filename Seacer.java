...
/**
 * SEACER - Sistema de Estimación y Alerta del Consumo Eléctrico Residencial.
...
public class Seacer {
    ...
    public static int leerEnteroEnRango(
            String mensaje, int minimo, int maximo) throws IOException {
    ...
    public static double leerDouble(String mensaje) throws IOException {
        while (true) {
            System.out.print(mensaje);
            String texto = ENTRADA.readLine().trim().replace(',', '.');
    ...
    public static double leerDoubleEnRango(
            String mensaje, double minimo, double maximo) throws IOException {
    ...
    public static String leerOpcionTexto(
            String mensaje, String opcion1, String opcion2) throws IOException {
    ...
    public static void cargarElectrodomesticos(
            String[] nombres, double[] potencias) {

        String[] catalogoNombres = {
            "Televisor", "Refrigeradora", "Lavadora", "Microondas",
            "Plancha", "Aire acondicionado", "Computadora", "Foco LED",
            "Ventilador", "Cargador de celular"
        };

        double[] catalogoPotencias = {
            150, 400, 500, 1200, 1000,
            2000, 300, 10, 75, 5
        };

        for (int i = 0; i < catalogoNombres.length; i++) {
    ...
    public static void mostrarMenu() {
        System.out.println();
        System.out.println("======================================================");
        System.out.println("       SEACER - Consumo Eléctrico Residencial");
        System.out.println("======================================================");
        System.out.println("1. Registrar electrodomésticos");
        System.out.println("2. Ver reporte general de consumo");
        System.out.println("3. Ver detalle de consumo por dispositivo");
        System.out.println("4. Clasificar consumo y generar alertas");
        System.out.println("5. Mostrar estadísticas y porcentajes");
        System.out.println("6. Comparar escenario actual con optimizado");
        System.out.println("7. Calcular intensidad de corriente y resistencia");
        System.out.println("8. Salir y mostrar matrices finales");
    }

    // ============================================================
    // REGISTRO Y NOMBRES REPETIDOS
    // ============================================================
    ...
    public static int registrarElectrodomesticos(
        ...
        while (continuar.equalsIgnoreCase("S")
            ...
            for (int i = 0; i < nombresCatalogo.length; i++) {
                System.out.printf(
                        "%d. %-22s %8.2f W%n",
                        i + 1,
                        nombresCatalogo[i],
            ...
            double diario = calcularConsumoDiario(
                    potenciasCatalogo[indiceCatalogo], horas);
            ...
            nombresSeleccionados[cantidad] = generarNombreUnico(
            ...
            /*
             * Se supone que los días de uso son consecutivos desde el lunes.
             * Cada celda guarda el consumo correspondiente a un solo día.
             */
            for (int dia = 0; dia < DIAS_SEMANA; dia++) {
                if (dia < dias) {
                    consumoSemana[cantidad][dia] = diario;
                } else {
                    consumoSemana[cantidad][dia] = 0;
                }
            }
    ...
    public static String generarNombreUnico(
        ...
        // Cuando aparece el segundo, también se numera el primero.
    ...
    public static void reporteGeneral(
        ...
        double diario = sumarColumna(
                datos, cantidad, COL_DIARIO);
        double semanal = sumarColumna(
                datos, cantidad, COL_SEMANAL);
        double mensual = sumarColumna(
                datos, cantidad, COL_MENSUAL);
        double anual = sumarColumna(
                datos, cantidad, COL_ANUAL);

        System.out.println(
                "\n--- Reporte general de consumo residencial ---");
        System.out.printf(
                "Dispositivos registrados: %d%n", cantidad);
        System.out.printf(
                "Consumo diario total: %.2f kWh%n", diario);
        System.out.printf(
                "Consumo semanal total: %.2f kWh%n", semanal);
        System.out.printf(
                "Consumo mensual estimado: %.2f kWh%n", mensual);
        System.out.printf(
                "Consumo anual estimado: %.2f kWh%n", anual);
        System.out.printf(
        ...
        System.out.printf(
                ...
                anual * tarifa);
        System.out.printf(
                "Tarifa aplicada: $%.2f por kWh%n", tarifa);
    }
    ...
    public static void detallePorDispositivo(
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            System.out.print("Consumo por día: ");
    ...
    public static void mostrarMatrizFinal(
        ...
        System.out.printf(" %12s%n", "Total sem.");
    ...
    public static void clasificarYAlertar(
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            boolean encendido =
                    estados[i].equalsIgnoreCase("Encendido");
        ...
        System.out.printf(
                "Consumo mensual: %.2f kWh%n", mensual);
        System.out.printf(
                "Equipos encendidos: %d%n", encendidos);
        System.out.printf(
                "Equipos de alta potencia: %d%n", altaPotencia);
        System.out.printf(
                "Índice de consumo: %.2f%n", indice);
        System.out.println(
    ...
    public static double calcularConsumoDiario(
        ...
        // Watts x horas = Wh. Se divide entre 1000 para obtener kWh.
    ...
    public static double calcularConsumoSemanal(
        ...
        // El consumo diario se repite durante los días indicados.
        return diario * dias;
    }
    ...
    public static double calcularConsumoMensual(
        ...
        // Un mes promedio tiene 52 / 12 = 4,33 semanas.
    ...
    public static double calcularConsumoAnual(
        ...
        // El año se estima con 52 semanas.
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] nombresCatalogo = new String[10];
        double[] potenciasCatalogo = new double[10];
        ...
        // Una posición por cada tipo del catálogo.
        int[] contadorPorTipo =
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    cantidad = registrarElectrodomesticos(
                            nombresCatalogo,
                            potenciasCatalogo,
                            nombresSeleccionados,
                            estados,
